...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 13, 2020 at 08:50 AM
...
INSERT INTO `users_schedule` (`id_schedule`, `schedule`, `schedule_teacher`) VALUES
(1, 'Mathematics', 'Ganjar Pranowo'),
(2, 'Applied English', 'Barack Obama'),
(3, 'Basic Programming', 'Isa Hamdan'),
(4, 'Java Programming', 'Isa Hamdan'),
(5, 'Basic Algorithm', 'Munih Dian'),
(6, 'Database Management', 'Bety Etikasari'),
(7, 'Object Oriented Programming', 'Isa Hamdan'),
(8, 'Business Management', 'Elly Antikasari'),
(9, 'Software Maintenance', 'Nugroho Setyo'),
(10, 'REST API', 'Angga Gumilang');
